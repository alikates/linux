...
DEFINE_RCG_COMMON(pclk0_clk_src, xo_dsi0pll_dsi1pll, NULL,
		clk_pixel_ops, 0x4D000, 8, CLK_SET_RATE_PARENT);
DEFINE_RCG_COMMON(pclk1_clk_src, xo_dsi1pll_dsi0pll, NULL,
		clk_pixel_ops, 0x4D0B8, 8, CLK_SET_RATE_PARENT);
DEFINE_RCG_COMMON(byte0_clk_src, xo_dsi0pllbyte_dsi1pllbyte, NULL,
		clk_byte2_ops, 0x4D044, 0, CLK_SET_RATE_PARENT);
DEFINE_RCG_COMMON(byte1_clk_src, xo_dsi1pllbyte_dsi0pllbyte, NULL,
		clk_byte2_ops, 0x4D0B0, 0, CLK_SET_RATE_PARENT);

#define DEFINE_BRANCH_COMMON(_name, _num_parents, _parent_hw,			\
			     _cbcr, _enable_bit,				\
...
#define DEFINE_BRANCH(_name, _parent, _cbcr)					\
	DEFINE_BRANCH_COMMON(_name, 1, &_parent.clkr.hw, _cbcr, 0,		\
			     CLK_SET_RATE_PARENT, BRANCH_HALT, _cbcr)

#define DEFINE_BRANCH_HALT(_name, _parent, _cbcr, _enable_bit,			\
			   _halt_check, _halt_reg)				\
	DEFINE_BRANCH_COMMON(_name, 1, &_parent.clkr.hw, _cbcr, _enable_bit,	\
			     CLK_SET_RATE_PARENT, _halt_check, _halt_reg)

#define DEFINE_BRANCH_EXT(_name, _cbcr)					\
	DEFINE_BRANCH_COMMON(_name, 0, NULL, _cbcr, 0,			\
			     0, BRANCH_HALT, _cbcr)

#define DEFINE_BRANCH_EXT_HALT(_name, _cbcr, _enable_bit,		\
			       _halt_check, _halt_reg)			\
	DEFINE_BRANCH_COMMON(_name, 0, NULL, _cbcr, _enable_bit,	\
...
DEFINE_BRANCH_EXT(gcc_bimc_gpu_clk, 0x59030);
DEFINE_BRANCH_EXT(gcc_camss_cpp_axi_clk, 0x58064);
DEFINE_BRANCH_EXT(gcc_camss_jpeg_axi_clk, 0x57028);
DEFINE_BRANCH_EXT(gcc_camss_ahb_clk, 0x56004);
DEFINE_BRANCH_EXT(gcc_camss_vfe0_axi_clk, 0x58048);
DEFINE_BRANCH_EXT(gcc_camss_vfe1_axi_clk, 0x58068);
DEFINE_BRANCH_EXT(gcc_dcc_clk, 0x77004);
DEFINE_BRANCH_EXT(gcc_mdss_ahb_clk, 0x4D07C);
DEFINE_BRANCH_EXT(gcc_mdss_axi_clk, 0x4D080);
DEFINE_BRANCH_EXT(gcc_mss_cfg_ahb_clk, 0x49000);
DEFINE_BRANCH_EXT(gcc_mss_q6_bimc_axi_clk, 0x49004);
DEFINE_BRANCH_EXT(gcc_bimc_gfx_clk, 0x59034);
DEFINE_BRANCH_EXT(gcc_oxili_ahb_clk, 0x59028);
DEFINE_BRANCH_EXT(gcc_oxili_timer_clk, 0x59040);
DEFINE_BRANCH_EXT(gcc_pdm_ahb_clk, 0x44004);
DEFINE_BRANCH_EXT(gcc_sdcc1_ahb_clk, 0x4201C);
DEFINE_BRANCH_EXT(gcc_sdcc2_ahb_clk, 0x4301C);
DEFINE_BRANCH_EXT(gcc_usb30_sleep_clk, 0x3F004);
DEFINE_BRANCH_EXT(gcc_venus0_ahb_clk, 0x4C020);
DEFINE_BRANCH_EXT(gcc_venus0_axi_clk, 0x4C024);
DEFINE_BRANCH_EXT_HALT(gcc_usb3_pipe_clk, 0x3F040, 0, BRANCH_HALT_DELAY, 0);
DEFINE_BRANCH_EXT_HALT(gcc_usb_phy_cfg_ahb_clk, 0x3F080, 0, BRANCH_VOTED, 0x3F080);
DEFINE_BRANCH_EXT_HALT(gcc_qusb_ref_clk, 0x41030, 0, BRANCH_HALT_SKIP, 0);
DEFINE_BRANCH_EXT_HALT(gcc_usb_ss_ref_clk, 0x3F07C, 0, BRANCH_HALT_SKIP, 0);
DEFINE_BRANCH_EXT_HALT(gcc_apss_axi_clk, 0x45004, 13, BRANCH_HALT_VOTED, 0x46020);
DEFINE_BRANCH_EXT_HALT(gcc_blsp1_ahb_clk, 0x45004, 10, BRANCH_HALT_VOTED, 0x01008);
DEFINE_BRANCH_EXT_HALT(gcc_blsp2_ahb_clk, 0x45004, 20, BRANCH_HALT_VOTED, 0x0B008);
DEFINE_BRANCH_EXT_HALT(gcc_boot_rom_ahb_clk, 0x45004, 7, BRANCH_HALT_VOTED, 0x1300C);
DEFINE_BRANCH_EXT_HALT(gcc_crypto_ahb_clk, 0x45004, 0, BRANCH_HALT_VOTED, 0x16024);
DEFINE_BRANCH_EXT_HALT(gcc_crypto_axi_clk, 0x45004, 1, BRANCH_HALT_VOTED, 0x16020);
DEFINE_BRANCH_EXT_HALT(gcc_qdss_dap_clk, 0x45004, 11, BRANCH_HALT_VOTED, 0x29084);
DEFINE_BRANCH_EXT_HALT(gcc_prng_ahb_clk, 0x45004, 8, BRANCH_HALT_VOTED, 0x13004);
DEFINE_BRANCH_EXT_HALT(gcc_cpp_tbu_clk, 0x4500C, 14, BRANCH_HALT_VOTED, 0x12040);
DEFINE_BRANCH_EXT_HALT(gcc_jpeg_tbu_clk, 0x4500C, 10, BRANCH_HALT_VOTED, 0x12034);
DEFINE_BRANCH_EXT_HALT(gcc_mdp_tbu_clk, 0x4500C, 4, BRANCH_HALT_VOTED, 0x1201C);
DEFINE_BRANCH_EXT_HALT(gcc_venus_tbu_clk, 0x4500C, 5, BRANCH_HALT_VOTED, 0x12014);
DEFINE_BRANCH_EXT_HALT(gcc_vfe1_tbu_clk, 0x4500C, 17, BRANCH_HALT_VOTED, 0x12090);
DEFINE_BRANCH_EXT_HALT(gcc_vfe_tbu_clk, 0x4500C, 9, BRANCH_HALT_VOTED, 0x1203C);
DEFINE_BRANCH_EXT_HALT(gcc_apss_tcu_async_clk, 0x4500C, 1, BRANCH_HALT_VOTED, 0x12018);
DEFINE_BRANCH_EXT_HALT(gcc_smmu_cfg_clk, 0x4500C, 12, BRANCH_HALT_VOTED, 0x12038);

DEFINE_BRANCH_COMMON(gcc_oxili_aon_clk, 1, &gfx3d_clk_src.clkr.hw,
		     0x59044, 0, 0, BRANCH_HALT, 0x59044);
DEFINE_BRANCH_COMMON(gcc_mdss_byte0_clk, 1, &byte0_clk_src.clkr.hw,
		     0x4D094, 0, CLK_SET_RATE_PARENT|CLK_IGNORE_UNUSED, BRANCH_HALT, 0x4D094);
DEFINE_BRANCH_COMMON(gcc_mdss_byte1_clk, 1, &byte1_clk_src.clkr.hw,
		     0x4D0A0, 0, CLK_SET_RATE_PARENT|CLK_IGNORE_UNUSED, BRANCH_HALT, 0x4D0A0);
DEFINE_BRANCH_COMMON(gcc_mdss_pclk0_clk, 1, &pclk0_clk_src.clkr.hw,
		     0x4D084, 0, CLK_SET_RATE_PARENT|CLK_IGNORE_UNUSED, BRANCH_HALT, 0x4D084);
DEFINE_BRANCH_COMMON(gcc_mdss_pclk1_clk, 1, &pclk1_clk_src.clkr.hw,
